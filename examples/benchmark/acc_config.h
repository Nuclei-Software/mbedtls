 ...
 */
#define MBEDTLS_HASH_ENABLE
#define MBEDTLS_CRYP_ENABLE
#define MBEDTLS_ACRYP_ENABLE
/* HASH and CRYP have the option of further acceleration using UDMA while
 * SOC have UDMA IP.
 */
#define MBEDTLS_UDMA_ENABLE

/* HASH/HMAC */
#if defined(MBEDTLS_HASH_ENABLE)
...
/* You can choose to use UDMA to accelerate the corresponding HASH algorithm,
   or not */
#if defined(MBEDTLS_UDMA_ENABLE)
...
#endif /* MBEDTLS_UDMA_ENABLE */
#endif /* HASH/HMAC */

/* CRYP */
#if defined(MBEDTLS_CRYP_ENABLE)
...
/* ACRYP */
#if defined(MBEDTLS_ACRYP_ENABLE)
