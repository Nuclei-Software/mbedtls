 ...
 */
/*
 * This is a file that describes Nuclei hardware accelerators macros. User can
 * enable the expected hardware acceleration macros in it and to enable hardware,
 * implement in accelerator/xlcrypto/xxx_alt.c, or disable it thus turning to
 * software implement in library/xxx.c.
 *
